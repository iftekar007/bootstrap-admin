        ...
        <a href="index2.html" class="logo">
          ...
          <!--  <span class="logo-mini"><b>A</b>LT</span>-->
            ...
            <span class="logo-lg">
                  ...
                  <img src="<?php print $logo; ?>" style="max-height:50px;max-width:200px;" >
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="<?php print $themepath;?>/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="#"><i class="fa fa-link"></i> <span>Test Link</span></a></li>
                <li class="treeview">
